...
export default function Suggestion({title, description, upvotes, comments, category}) {
  return (
    <div className="bg-white w-full flex space-x-10 px-8 py-8 h-[9.4rem] rounded-md shadow-md">

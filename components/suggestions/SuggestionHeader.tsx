...
export default function SuggestionHeader({
  ...
  return (
    <div className="bg-[#373F68] h-[4.5rem] md:rounded-md flex items-center justify-between md:justify-center md:space-x-7 md:px-5 px-2">
      <svg width="23" height="24" xmlns="http://www.w3.org/2000/svg" className="hidden md:block">
        <path
